# Default PIG Configuration for Cityscapes->ACDC
_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/models/daformer_sepaspp_mitb5.py',
    '../_base_/datasets/nfnet_cs2acdc.py',
...
name = 'city2acdc_pig'
exp = 'basic'
name_dataset = 'city2acdc'
name_architecture = 'hrda_daformer_sepaspp_sl_mitb5'
name_encoder = 'mitb5'
name_decoder = 'hrda_daformer_sepaspp_sl'
